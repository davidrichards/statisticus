# This is similar to the Student's T Test, except that it is used for
...
module Statisticus #:nodoc:
  class Wilcox < RWrapper
    def run(list1=nil, list2=nil)
      list1 ||= @list1
      list2 ||= @list2
      # TODO: Not working in RSRuby, but OK in R
      r.wilcox.test(list1, list2)
    end
  end
end
